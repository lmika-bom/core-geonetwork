...
)
{
    ...
    #==============================================================================
    package { ["postgresql${postgresql_short_version}", "postgresql${postgresql_short_version}-server", "postgresql${postgresql_short_version}-libs", "postgresql${postgresql_short_version}-contrib", "postgresql${postgresql_short_version}-devel"]:
      ensure  => latest,
    ...
    package { ["postgis${postgis_major_version}_${postgresql_short_version}", "ogr_fdw${postgresql_short_version}", "pgrouting_${postgresql_short_version}"]:
      ensure => latest,
    }
